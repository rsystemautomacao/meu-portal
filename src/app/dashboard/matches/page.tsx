                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {matches.map((match) => (
                    <tr key={match.id}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        {/* Exibir apenas o botão de copiar link para partidas em andamento com matchSheet, nunca mostrar 'Criar Súmula' */}
              ...
              {sumulaLink ? (
                <div className="bg-gradient-to-r from-green-100 via-emerald-50 to-blue-50 rounded-2xl p-8 border-2 border-green-300 shadow-xl animate-fade-in">
                  <div className="flex flex-col items-center mb-4">
                    ...
                    <div className="text-2xl font-extrabold text-green-900 mb-1">Súmula Online Gerada!</div>
                    <div className="text-base text-green-700 mb-4">Compartilhe o link abaixo para preencher a súmula em tempo real.</div>
                  </div>
