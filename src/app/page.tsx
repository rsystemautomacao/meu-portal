  ...
  return (
    <div className="bg-gradient-to-b from-primary/5 to-secondary/5">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        {/* Admin Link - Invisível mas clicável */}
        <div className="absolute top-4 right-4 z-10">
          <Link
            href="/admin"
            className="text-xs text-transparent hover:text-gray-700 transition-colors opacity-0 hover:opacity-100 w-8 h-8 flex items-center justify-center"
            title="Admin (invisível)"
          >
            Admin
          </Link>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Tudo que você precisa para gerenciar seu time
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Uma plataforma completa com todas as ferramentas necessárias para organizar seu time de forma profissional.
            </p>
          </div>
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Cadastre jogadores, gerencie status, números e posições. Mantenha um histórico completo de cada atleta.
                  </p>
                </dd>
              </div>
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Acompanhe gols, assistências, cartões e outras estatísticas importantes de cada partida.
                  </p>
                </dd>
              </div>
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Gerencie mensalidades, despesas e receitas do time. Mantenha as finanças sempre organizadas.
                  </p>
                </dd>
              </div>
            </dl>
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary">Aplicativo Web Progressivo</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Funciona como um app nativo
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Instale o Meu Portal no seu dispositivo e tenha acesso rápido, mesmo sem internet.
            </p>
          </div>
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Instale o aplicativo diretamente do navegador. Aparece na tela inicial como um app nativo.
                  </p>
                </dd>
              </div>
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Acesse dados importantes mesmo sem conexão com a internet. Sincroniza automaticamente quando online.
                  </p>
                </dd>
              </div>
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">
                    Receba notificações sobre partidas, pagamentos e outras atividades importantes do time.
                  </p>
                </dd>
              </div>
            </dl>
