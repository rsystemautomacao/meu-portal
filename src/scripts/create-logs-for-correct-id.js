...
async function createLogsForCorrectId() {
  try {
    console.log('🧪 Criando logs para o ID correto...')

    const correctUserId = '6880f4eeac3451d18d8284fb'
    ...
    if (!user) {
      console.log('❌ Usuário com ID correto não existe')
      return
    }
    ...
    console.log('🎉 Logs de teste criados para o ID correto!')
