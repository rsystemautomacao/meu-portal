...
async function createLogsForApiId() {
  try {
    console.log('🧪 Criando logs para o ID da API...')

    const apiUserId = '6880f4eeac3451d18d8284fb'
    ...
    if (!user) {
      console.log('❌ Usuário da API não existe')
      return
    }
    ...
    console.log('🎉 Logs criados para o ID da API!')
